...
const EightLevel = () => {
  ...
  const size = 12; // Set maze size to 7
...
const generateCollectibles = () => {
  const collectibles = [];
  let remainingCollectibles = 23; // Number of collectibles to be added
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (elapsedTime > 55000) { // For example, if time exceeds 30 seconds
    ...
    return ( 
      ...
      <h2 style={{fontSize: '35px'}}>Click anywhere on the Maze to Start the Game</h2>
