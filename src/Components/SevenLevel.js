...
const SevenLevel = () => {
  ...
  const size = 11; // Set maze size to 7
...
const generateCollectibles = () => {
  const collectibles = [];
  let remainingCollectibles = 20; // Number of collectibles to be added
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (elapsedTime > 50000) { // For example, if time exceeds 30 seconds
